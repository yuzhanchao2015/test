...
<div>
    <div class="ele-container">
        <div class="four0fourwrap">
            <h1 class="four0four">404</h1>
            <h1 class="f0ftext">页面不晓得跑哪里去了</h1>
        </div>
    ...
    <div class="backBtn">
        <!-- <router-link class='backBtnText' to="/sign">返回首页</router-link> -->
        <a class='backBtnText' @click = "$router.push({path:'/'})">返回首页</a>
    </div>
</div>
</template>
<script>
...
.backBtn {
    ...
    height: 11vw;
    line-height: 11vw;
    background-color: rgba(75, 196, 123, 0.5);
    margin: 0 auto;
    border-radius: 4px;
}
.backBtnText {
...
.ele-container {
  background: -webkit-linear-gradient(top, rgba(75, 196, 123, 0.5) 0%, transparent 100%);
  background: linear-gradient(to bottom, rgba(75, 196, 123, 0.5) 0%, transparent 100%);
  height: 86vh;
  overflow: hidden;
  position: relative;
  width: 100%;
